...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  Code should follow pep8 conventions for readability.
  Code should have comments that explain the logic, even though good code is self explanatory.
  Code should have doctring for documentation.
  Code should follow proper naming conventions.
  Code should have Unit Tests to ensure functionality.
...
- We have an awful lot of computers here, and it gets pretty confusing with
  ...
  containers enable reproducibility and enables code to scale.
  containers also are smaller in size compared to virtual environments, allowing
  the ecosystem to run faster.  
